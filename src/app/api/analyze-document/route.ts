 ...
 * Backend-only OpenAI — Frontend 以 FormData 上載，不可直連 OpenAI。
 *
 * formData fields:
 * - file (File, optional)
 * - text / loanType / amountHkd / purpose / companyName
 */
